                ...
                <div class="inner">
                    ...
                    <main class="main">
                        <article class="main_article">
                            ...
                            <div class="greeting">
                                <p>来る2023年（令和5年）10月7日（土）・8日（日）の2日間、長崎市に新設されました出島メッセ長崎におきまして、「第51回日本歯科麻酔学会総会・学術集会」ならびに「第14回アジア歯科麻酔学会連合学術大会（14th
                                    FADAS）」を開催させていただく運びとなりました。
                                </p>
                                <p>
                                ...
                                <p>
                                    参加者の皆様にとって、有意義で発展が期待できる会議となるよう、会長、プログラム委員、事務局が一丸となり、多くの魅力的な企画を練って参ります。多くのご参加をお待ちしております。
